...
class RideRequest{
  ...
  RideRequest({
    this.createdAt, this.driverId, this.dropOffAddress, this.pickUpAddress,
    this.riderName, this.riderPhone, this.dropOff, this.pickUp,
  });
...
class RideDetails{
  ...
  RideDetails({this.pickUpAddress, this.dropOffAddress, this.pickUp, this.dropOff,
    this.rideRequestId, this.riderName, this.riderPhone,
  });
}
