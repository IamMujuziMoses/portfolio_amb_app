...
class DatabaseMethods{
  ...
  getDriverByUsername(String username) async{
    ...
    driverSnap = await driversCollection.where("name", isEqualTo: username.trim()).get();
  ...
  Future<String> getUserDocId(String uid) async {
    QuerySnapshot driverSnap;
    driverSnap = await usersCollection.where("uid", isEqualTo: uid.trim()).get();
    String id = driverSnap.docs[0].id.trim();
    return id;
  }
  ...
  Future<String> getDoctorDocId(String uid) async {
    QuerySnapshot driverSnap;
    driverSnap = await doctorsCollection.where("uid", isEqualTo: uid.trim()).get();
    String id = driverSnap.docs[0].id.trim();
    return id;
  }
  ...
  getDriverByUserEmail(String userEmail) async{
    QuerySnapshot driverSnap;
    driverSnap = await driversCollection.where("email",isEqualTo: userEmail).get();
  ...
  Future<Map<String, dynamic>> driverSnapToMap(String name, QuerySnapshot snap) async {
  ...
  getRideRequest(String rideRequestId) async {
    ...
    requestSnap = await rideRequestCollection.where("uid", isEqualTo: rideRequestId.trim()).get();
    return requestSnap;
  }
}