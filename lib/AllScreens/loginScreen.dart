                      ...
                      FlatButton(
                        ...
                        onPressed: () async {
                          if (resetPasswordEmailTEC.text.isEmpty) {
                            ...
                            await FirebaseAuth.instance.sendPasswordResetEmail(email: resetPasswordEmailTEC.text);
                            Navigator.of(context).pop();
                            showSimpleNotification(
                              Text("A password reset link has been sent to ${resetPasswordEmailTEC.text}", style: TextStyle(
                                fontFamily: "Brand Bold",
